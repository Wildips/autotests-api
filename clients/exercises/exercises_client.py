...
from clients.exercises.exercises_schema import GetExercisesQuerySchema, GetExercisesResponseSchema, \
    CreateExerciseResponseSchema, CreateExerciseRequestSchema, UpdateExerciseRequestSchema, UpdateExerciseResponseSchema
...
class ExercisesClient(APIClient):
    ...
    def get_exercises(self, query: GetExercisesQuerySchema) -> GetExercisesResponseSchema:
        """
        Метод обертка для get_exercises_api.
    ...
    def get_exercise(self, exercise_id: str) -> CreateExerciseResponseSchema:
        """
        Метод обертка для get_exercise_api.
    ...
    def create_exercise(self, request: CreateExerciseRequestSchema) -> CreateExerciseResponseSchema:
        """
        Метод обертка для create_exercise_api.
    ...
    def update_exercise_api(self, exercise_id: str, request: UpdateExerciseRequestSchema) -> Response:
        ...
        :return: Ответ от сервера в виде объекта httpx.Response
        """
        return self.patch(f"{APIRoutes.EXERCISES}/{exercise_id}", json=request)

    def update_exercise(self, exercise_id: str, request: UpdateExerciseRequestSchema) -> UpdateExerciseResponseSchema:
        """
        Метод обертка для update_exercise_api.
